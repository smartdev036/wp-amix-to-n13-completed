...
// Ajax Post
add_action('wp_ajax_loadAjaxNews', 'loadAjaxNews_handler');
add_action('wp_ajax_nopriv_loadAjaxNews', 'loadAjaxNews_handler');

function loadAjaxNews_handler() {
...
function custom_email_confirmation_validation_filter( $result, $tag ) {
  if ( 'confirm_email' == $tag->name ) {
    $your_email = isset( $_POST['email'] ) ? trim( $_POST['email'] ) : '';
    $your_email_confirm = isset( $_POST['confirm_email'] ) ? trim( $_POST['confirm_email'] ) : '';
